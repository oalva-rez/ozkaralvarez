...
function Contact() {
    ...
    async function handleSubmit(e) {
        ...
        if (response.status === 200) {
            ...
            toast.update(id, {
                render: "Oh no... Something went terribly wrong. Please use other form of contact.",
                type: "error",
                isLoading: false,
                autoClose: 3000,
            });
        ...
        <>
            ...
            <main className="contact">
                ...
                <div className="contact-container">
                    <h2>Get In Touch</h2>
                    <p>
                        My inbox is always open. Use the form below for any
                        ideas, questions, pizza party? Look forward to hearing
                        from you.
                    </p>
