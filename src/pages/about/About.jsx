      ...
      <main className="about">
        ...
        <div>
          <div className="about--text">
            <p>
              A few years ago, I discovered my love for web development, which
              was a natural extension of my passion for engineering. I saw the
              internet as a vast playground where I could apply my creativity
              and engineering skills to build incredible things that people
              could use and enjoy.
            </p>
            <p>
            ...
            <p>
              ...
              striving for perfection. I know that every line of code I write
              can have a significant impact on the user's experience, so I take
              great care in ensuring that everything I build is of the highest
              quality.
            </p>
          </div>
